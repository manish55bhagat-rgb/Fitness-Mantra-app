      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-24 mb-32">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-white/30 text-xs font-semibold uppercase tracking-tight leading-relaxed mb-10 italic">
              "Professional fitness and personalized diets to start your transformational journey."
            </p>
          ...
          <div>
            <h4 className="font-black text-[10px] uppercase tracking-[0.4em] mb-12 text-white/20">Our Plans</h4>
            <ul className="space-y-6 text-[10px] font-black uppercase tracking-widest text-white/40">
              <li><Link to="/subscription" className="hover:text-neon-green transition-colors flex items-center gap-3 italic">30 Days Plan <Zap className="w-3 h-3 text-neon-green/20" /></Link></li>
              <li><Link to="/subscription" className="hover:text-neon-green transition-colors flex items-center gap-3 italic">90 Days Plan <Zap className="w-3 h-3 text-neon-green/20" /></Link></li>
              <li><Link to="/subscription" className="hover:text-neon-green transition-colors flex items-center gap-3 italic">6 Months Plan <Zap className="w-3 h-3 text-neon-green/20" /></Link></li>
              <li><Link to="/subscription" className="hover:text-neon-green transition-colors flex items-center gap-3 italic">Premium Plans <Zap className="w-3 h-3 text-neon-green/20" /></Link></li>
            </ul>
          </div>

          <div>
            <h4 className="font-black text-[10px] uppercase tracking-[0.4em] mb-12 text-white/20">Quick Links</h4>
            <ul className="space-y-6 text-[10px] font-black uppercase tracking-widest text-white/40">
              ...
              <li><Link to="/exercises" className="hover:text-neon-green transition-colors italic">Workout Library</Link></li>
              ...
              <li><Link to="/contact" className="hover:text-neon-green transition-colors italic">Contact Us</Link></li>
            </ul>
          </div>
        ...
        <div className="pt-20 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-12">
          ...
          <div className="flex flex-col md:items-end gap-2">
            <div className="text-[10px] font-black tracking-[0.3em] text-white/30 uppercase flex flex-col md:flex-row gap-4 md:gap-8">
              <span>© 2026 FITNESS MANTRA</span>
              <span className="text-neon-green">MANISH BHAGAT: 9765690437</span>
            </div>
            <div className="flex items-center gap-2 text-[8px] font-black text-white/10 uppercase tracking-[0.4em]">
              <Shield className="w-3 h-3" /> CERTIFIED FITNESS COACHING PLATFORM
            </div>
          </div>
        </div>
      </div>
